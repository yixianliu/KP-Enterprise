    ...
    new baTableApi('/admin/payment.Methods/'),
    {
        ...
        column: [
            ...
            },
            {
                ...
                sortable: false,
                render: 'tag',
                replaceValue: { online: 'type online', offline: 'type offline', bank: 'type bank' },
            },
            { label: t('payment.methods.icon'), prop: 'icon', align: 'center', render: 'icon', operator: false },
            {
            ...
            { label: t('payment.methods.sort_order'), prop: 'sort_order', align: 'center', sortable: false, operator: 'RANGE' },
            {
                ...
                sortable: false,
                render: 'tag',
                replaceValue: { '0': t('payment.methods.active_status 0'), '1': t('payment.methods.active_status 1') },
            },
            {
