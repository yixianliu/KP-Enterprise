...
const baTable = new baTableClass(
    new baTableApi('/admin/ai.training.Task/'),
    {
        ...
        column: [
            ...
            { label: t('ai.training.task.id'), prop: 'id', align: 'center', width: 70, operator: 'RANGE', sortable: 'custom' },
            {
            ...
            { label: t('ai.training.task.training_data'), prop: 'training_data', align: 'center', operator: 'eq', sortable: false, render: 'tag' },
            {
