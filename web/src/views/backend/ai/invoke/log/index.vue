...
const baTable = new baTableClass(
    new baTableApi('/admin/ai.invoke.Log/'),
    {
        ...
        column: [
            ...
            { label: t('ai.invoke.log.id'), prop: 'id', align: 'center', width: 70, operator: 'RANGE', sortable: 'custom' },
            {
            ...
            { label: t('ai.invoke.log.metadata'), prop: 'metadata', align: 'center', operator: 'eq', sortable: false, render: 'tag' },
            {
