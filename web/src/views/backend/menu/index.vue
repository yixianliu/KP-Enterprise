...
const baTable = new baTableClass(
    new baTableApi('/admin/Menu/'),
    {
        ...
        column: [
            ...
            { label: t('menu.id'), prop: 'id', align: 'center', width: 70, operator: 'RANGE', sortable: 'custom' },
            {
            ...
            { label: t('menu.title'), prop: 'title', align: 'center', operatorPlaceholder: t('Fuzzy query'), sortable: false, operator: 'LIKE' },
            { label: t('menu.slug'), prop: 'slug', align: 'center', operatorPlaceholder: t('Fuzzy query'), sortable: false, operator: 'LIKE' },
